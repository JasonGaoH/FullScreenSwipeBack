...
/**
 * me.imid.swipebacklayout.lib.ViewDragHelper is a utility class for writing custom ViewGroups. It offers a
...
public class ViewDragHelper {
    private static final String TAG = "me.imid.swipebacklayout.lib.ViewDragHelper";
     ...
     * the me.imid.swipebacklayout.lib.ViewDragHelper with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the me.imid.swipebacklayout.lib.ViewDragHelper will enter
         ...
         * place and the me.imid.swipebacklayout.lib.ViewDragHelper will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * me.imid.swipebacklayout.lib.ViewDragHelper may call this method multiple times for the same view
    ...
    /**
     * Factory method to create a new me.imid.swipebacklayout.lib.ViewDragHelper.
     *
     * @param forParent Parent view to monitor
     * @param cb        Callback to provide information and receive events
     * @return a new me.imid.swipebacklayout.lib.ViewDragHelper instance
     */
    ...
    /**
     * Apps should use me.imid.swipebacklayout.lib.ViewDragHelper.create() to get a new instance. This will
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the me.imid.swipebacklayout.lib.ViewDragHelper's tracked parent view (" + mParentView + ")");
        }
     ...
     * (to the best of the me.imid.swipebacklayout.lib.ViewDragHelper's knowledge).
     * <p>
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A me.imid.swipebacklayout.lib.ViewDragHelper can only manipulate one view at a time.
